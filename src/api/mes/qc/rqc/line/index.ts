...
/** 查询退货检验单行分页 */
export function getRqcLinePage(params: PageParam) {
  return http.get<PageResult<QcRqcLine>>('/mes/qc/rqc/line/page', params)
}

/** 查询退货检验单行详情 */
export function getRqcLine(id: number) {
  return http.get<QcRqcLine>(`/mes/qc/rqc/line/get?id=${id}`)
}
