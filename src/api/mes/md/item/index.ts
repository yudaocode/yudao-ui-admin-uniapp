...
export function getItemPage(params: PageParam) {
  return http.get<PageResult<MdItem>>(`/mes/md/item/page`, params)
}

/** 查询物料产品详情 */
export function getItem(id: number) {
  return http.get<MdItem>(`/mes/md/item/get?id=${id}`)
}

/** 新增物料产品（返回新物料 ID） */
export function createItem(data: MdItem) {
  return http.post<number>(`/mes/md/item/create`, data)
}

/** 修改物料产品 */
export function updateItem(data: MdItem) {
